...
**Migration Required:** See [UPGRADE.md](UPGRADE.md) for detailed upgrade instructions.
...
- **SETUP.md** - Comprehensive setup guide for new installations
- **UPGRADE.md** - Migration guide for existing installations
...
- **v1.x → v2.0:** See [UPGRADE.md](UPGRADE.md)

---

## Support

- **New installations:** Follow [SETUP.md](SETUP.md)
- **Existing installations:** Follow [UPGRADE.md](UPGRADE.md)
